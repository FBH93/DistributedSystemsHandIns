...
func (c *chittyChatClient) Chat(ctx context.Context, opts ...grpc.CallOption) (ChittyChat_ChatClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChittyChat_ServiceDesc.Streams[0], "/ChittyChat.ChittyChat/Chat", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *chittyChatChatClient) Send(m *ChatRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *chittyChatChatClient) Recv() (*ChatResponse, error) {
	m := new(ChatResponse)
...
func (x *chittyChatChatServer) Send(m *ChatResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *chittyChatChatServer) Recv() (*ChatRequest, error) {
	m := new(ChatRequest)
